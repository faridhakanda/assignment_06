                    ...
                    {datas.map(data => 
                        <div key={data.id} className={`${data.active ? 'bg-gradient-to-l from-[#9514FA] to-[#4F39F6] text-[#FFFFFF]': 'bg-[#F9FAFC]'} mx-3 my-6 p-2 text-center rounded-md shadow-md `}>
                            ...
                            <div className='text-start p-2 my-2'>
                                ...
                                <button className={`${data.active ? 'bg-[#F9FAFC] text-[#9514F1] ':'bg-gradient-to-l from-[#9514FA] to-[#4F39F6] text-[#FFFFFF]'} font-semibold px-2 py-2 rounded-full mx-auto  justify-center w-full cursor-pointer`}>{data.button}</button>
                            </div>
                        </div>
                    )}
