        ...
        <div className='flex justify-between space-x-5 bg-gray-300 p-5 m-1 rounded-md '>
            <div className='flex items-center space-x-3'>
                <div className='w-[42px] h-[42px] items-center bg-[#FFFFFF] rounded-full'>
                    <img className='items-center justify-center m-1 ' src={operation} alt="operatoin" />
                </div>
                
                <div>
                    <h2 className='font-semibold text-[20px] text-[#101727]'>AI Product</h2>
                    <p className='text-[#627382] font-medium text-[16px]'>$29</p>
                </div>
            </div>
